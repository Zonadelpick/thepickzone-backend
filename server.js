...
app.get('/api/fixtures/odds', async (req, res) => {
  try {
    const { league } = req.query;
    const SPORT_KEYS = {
      'Liga de España':'soccer_spain_la_liga',
      'Segunda División España':'soccer_spain_segunda_division',
      'Süper Lig':'soccer_turkey_super_league',
      'Pro League Bélgica':'soccer_belgium_first_div',
      'Países Bajos':'soccer_netherlands_eredivisie',
      'Primeira Liga Portugal':'soccer_portugal_primeira_liga',
      'Super League Grecia':'soccer_greece_super_league',
      'EuroLeague':'basketball_euroleague',
      'WNBA':'basketball_wnba',
      'NPB':'baseball_npb','KBO':'baseball_kbo',
      ...
      'Liga Brasil':'soccer_brazil_campeonato',
      'Brasileirao':'soccer_brazil_campeonato',
      'Serie B Brasil':'soccer_brazil_serie_b',
      'Liga Chile':'soccer_chile_campeonato',
      ...
      'Liga Holanda':'soccer_netherlands_eredivisie',
      'Eredivisie':'soccer_netherlands_eredivisie',
      'Liga Escocia':'soccer_spl',
      'Scottish Premiership':'soccer_spl',
      'Liga Noruega':'soccer_norway_eliteserien',
      'Liga Suecia':'soccer_sweden_allsvenskan',
      'Liga Suiza':'soccer_switzerland_superleague',
      'Liga Polonia':'soccer_poland_ekstraklasa',
      'Liga Dinamarca':'soccer_denmark_superliga',
      'Liga Japon':'soccer_japan_j_league',
      'J League':'soccer_japan_j_league',
      'K League':'soccer_korea_kleague1',
      'Liga Corea':'soccer_korea_kleague1',
      'Liga China':'soccer_china_superleague',
      'Liga Australia':'soccer_australia_aleague',
      'A-League':'soccer_australia_aleague',
      'DFB Pokal':'soccer_germany_dfb_pokal',
      'Coppa Italia':'soccer_italy_coppa_italia',
      'Coupe de France':'soccer_france_coupe_de_france',
      'Liga Arabia Saudita':'soccer_saudi_arabia_pro_league',
      'Liga Rusia':'soccer_russia_premier_league',
      'Liga Brasil':'soccer_brazil_campeonato',
      'Liga Chile':'soccer_chile_campeonato',
      ...
      'Liga de Espana':'soccer_spain_la_liga','Liga España':'soccer_spain_la_liga','Liga de España':'soccer_spain_la_liga',
      ...
      'Turquia':'soccer_turkey_super_league','Turkey Super League':'soccer_turkey_super_league',
      'Liga Turquia':'soccer_turkey_super_league',
      'Eredivisie':'soccer_netherlands_eredivisie','Liga Holanda':'soccer_netherlands_eredivisie',
      'Liga Portugal':'soccer_portugal_primeira_liga','Primeira Liga':'soccer_portugal_primeira_liga',
      'Liga Belgica':'soccer_belgium_first_div',
      'Concacaf Champions':'soccer_concacaf_gold_cup',
      'CONCACAF':'soccer_concacaf_gold_cup',
      'Liga Mexico':'soccer_mexico_ligamx',
      'Liga MX Femenil':'soccer_mexico_ligamx',
      'FA Cup':'soccer_fa_cup',
      'UEFA Europa':'soccer_uefa_europa_league','Europa League':'soccer_uefa_europa_league',
      'Conference League':'soccer_uefa_europa_conference_league',
      'Saudi Pro League':'soccer_saudi_arabia_pro_league',
      'Liga Arabia':'soccer_saudi_arabia_pro_league',
      'WNBA':'basketball_wnba',
      'UFC':'mma_mixed_martial_arts','MMA':'mma_mixed_martial_arts'
    };
